  ...
  return (
    <section className="relative py-28 overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-10 text-center">
        ...
        >
          Whether you need custom wood works, fabrication,
          aluminium solutions, false ceilings, or complete
          interior work, VEYOR is ready to deliver quality
          craftsmanship with professional execution.
        </motion.p>
